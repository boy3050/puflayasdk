...
(function(PFU) {
    ...
    var PfuManager = function() {
        ...
        PfuManager.prototype.ShowMoreGameImage = function(isLeft, index, callServer, fun) {
            ...
            PFU.PfuPlatformManager.GetInstance().StatisticsMsg2201(PFU.PlatformStatisticsType.moreGame, data.link);
...
var PfuSdk = function() {
    ...
    PfuSdk.Video = function(handle, fun) {
        ...
        if (this._sdkVideoShareFinish && PFU.PfuManager.GetInstance().IsPfuSdkVideoShare()) {
            PFU.PfuGlobal.PfuShareVideo(this, function(type, desc) {
                if (type == PfuSdk.SUCCESS) {
                    ...
                    _this.PlayVideo(handle, fun, true);
                } else {
        ...
        this.PlayVideo(handle, fun, false);
    };
    PfuSdk.PlayVideo = function(handle, fun, shareIn) {
        var _this = this;

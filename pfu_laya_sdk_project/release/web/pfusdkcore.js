    ...
    var PfuPlatformManager = function() {
        ...
        PfuPlatformManager.prototype.StatisticsMsg2201 = function(type, picId) {
            ...
            if (type == PlatformStatisticsType.shareGame) {
                var t = (Date.now() - this.lastSend2201Type7Time) / 1e3;
                if (t < 2e3) {
                    return;
                }
            }
        ...
        PfuPlatformManager.prototype.StatisticsMsg2202 = function() {
            ...
            var t = (Date.now() - this.lastSend2202Time) / 1e3;
            if (t < 2e3) {
                return;
            }
...
(function(PFU) {
    var PfuClickBannerRevive = function() {
        ...
        Object.defineProperty(PfuClickBannerRevive.prototype, "IsClickBannerAward", {
            get: function() {
                return this._isClickBannerAward;
            },
            enumerable: true,
            configurable: true
        });
        ...
        PfuClickBannerRevive.prototype.SkipBannerRefresh = function() {
            ...
            this._isClickBannerAward = false;
            PFU.PfuGlobal.RefreshBanner(function() {}, this._tempBannerDir, PFU.WeChatBannerAd.customWidth);
        };
...
(function(PFU) {
    var PfuRedPacketManager = function() {
        ...
        PfuRedPacketManager.prototype.AwardGift = function() {
            ...
            if (this._redpacketData.awardRedCount < 20) {
                awardCount = PFU.BXRandom.Get().nextFloat(.12, .4);
            } else {
                awardCount = PFU.BXRandom.Get().nextFloat(.03, .2);
            }
    ...
    PfuRedPacketManager.moneyList = [ 1.15, 1.3, .8, .2, .35, .2, .51 ];
    PfuRedPacketManager.resulet_rmb = 10.78;
...
var PfuSdk = function() {
    ...
    PfuSdk.VideoRevive = function(handle, fun, adunit, isForceShare) {
        ...
        if (this._clickBannerShowTime == 0 || this._clickBannerShowTime > 0 && Date.now() - this._clickBannerShowTime >= 6e4) {
...
PfuSdk.UI_ORDER_MOREGAME = 9e4;

PfuSdk.UI_FIRST_SCENEBOX = 1e10;

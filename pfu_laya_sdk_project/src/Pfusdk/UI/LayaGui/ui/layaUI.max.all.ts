...
module ui {
    export class ClickBannerUIUI extends View {
		public loaderImg:Laya.Sprite;
		public cancel:Laya.Image;

        public static  uiView:any ={"type":"View","props":{"width":750,"height":1334},"child":[{"type":"Sprite","props":{"y":-133,"width":750,"var":"loaderImg","height":1600}},{"type":"Image","props":{"y":813,"x":331,"var":"cancel","skin":"comp/dianjifuhuo.png"}}]};
        constructor(){ super()}
        createChildren():void {

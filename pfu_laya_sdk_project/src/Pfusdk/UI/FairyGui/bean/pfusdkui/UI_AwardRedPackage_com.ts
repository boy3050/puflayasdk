...
module pfusdkui {
	...
	export class UI_AwardRedPackage_com extends fairygui.GComponent {
		...
		protected constructFromXML(xml: any): void {
			...
			this.m_n23 = <fairygui.GTextField><any>(this.getChildAt(10));
			this.m_allMoney = <fairygui.GTextField><any>(this.getChildAt(11));
			this.m_n25 = <fairygui.GTextField><any>(this.getChildAt(12));
		}
	}
}